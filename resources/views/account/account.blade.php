                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="address">{{ $session->get_meta('address') }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="col-form-label">Additional Information</label>
                                                <textarea class="form-control" name="additional_info">{{ $session->get_meta('additional_info') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
