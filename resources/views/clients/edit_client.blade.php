                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">All Clients</a>
                                        </li>
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('client.update', ['id' => $client->id]) }}" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="col-form-label">Distributor Name</label>
                                                <select class="form-control" name="distributor_id">
                                                    @foreach($distributors as $v)
                                                        <option value="{{ $v->id }}" <?= ($client->distributor_id == $v->id) ? 'selected' : '' ?>>{{ $v->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="col-form-label">Whatsapp Phone</label>
                                                <input type="text" class="form-control" name="whatsapp_number" value="{{ $client->whatsapp_number }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="region">
                                                    <option value="sindh" <?= ($client->region == "sindh") ? 'selected' : '' ?>>Sindh</option>
                                                    <option value="punjab" <?= ($client->region == "punjab") ? 'selected' : '' ?>>Punjab</option>
                                                    <option value="kpk" <?= ($client->region == "kpk") ? 'selected' : '' ?>>KPK</option>
                                                    <option value="balochistan" <?= ($client->region == "balochistan") ? 'selected' : '' ?>>Balochistan</option>
                                                    <option value="gilgit_baltistan" <?= ($client->region == "gilgit_baltistan") ? 'selected' : '' ?>>Gilgit Baltistan</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="city" class="form-control">
                                                    ...
                                                    <option class="option" value="Banda Daud Shah">Banda Daud Shah
                                                    </option>
                                                    ...
                                                    <option class="option" value="Dera Ghazi Khan">Dera Ghazi Khan
                                                    </option>
                                                    ...
                                                    <option class="option" value="Mandi Bahauddin">Mandi Bahauddin
                                                    </option>
                                                    ...
                                                    <option class="option" value="Musa Khel Bazar">Musa Khel Bazar
                                                    </option>
                                                    ...
                                                    <option class="option" value="Qamruddin Karez">Qamruddin Karez
                                                    </option>
                                                    ...
                                                    <option class="option" value="Qila Saifullah">Qila Saifullah
                                                    </option>
                                                    <option class="option" value="Rawalpindi">Rawalpindi</option>
                                                    <option class="option" value="Rabwah">Rabwah</option>
                                                    <option class="option" value="Rahim Yar Khan">Rahim Yar Khan
                                                    </option>
                                                    ...
                                                    <option class="option" value="Safdar Abad- (Dhaban Singh)">Safdar
                                                        Abad
                                                    </option>
                                                    ...
                                                    <option class="option" value="Shahpur Chakar">Shahpur Chakar
                                                    </option>
                                                    <option class="option" value="Shakargarh">Shakargarh</option>
                                                    <option class="option" value="Shangla">Shangla</option>
                                                    <option class="option" value="Sharam Jogizai">Sharam Jogizai
                                                    </option>
                                                    ...
                                                    <option class="option" value="Tar Ahamd Rind">Tar Ahamd Rind
                                                    </option>
                                                    <option class="option" value="Thalo">Thalo</option>
                                                    <option class="option" value="Thatta">Thatta</option>
                                                    <option class="option" value="Toba Tek Singh">Toba Tek Singh
                                                    </option>
